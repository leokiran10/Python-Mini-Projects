...
# Answers array
answers = ["central processing unit", "mouse", "graphics processing unit", "keyboard", "random access memory", "motherboard", "read only memory", "hardware", "uniform resource locator", "cookie"]
